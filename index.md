...
[![_config.yml]({{ site.baseurl }}/assets/img/join_team_channel.png){: width="100" height="100"}](https://xwarewallet.slack.com/messages/C7RPB5D37/)
[#Join us on Slack](https://xwarewallet.slack.com/messages/C7RPB5D37/)
...
**프랑스 파리에서는**
- 자전거로 출퇴근 하는 시민에게 km당 350원 정도의 인센티브를 제공하고 있습니다.   
- 자전거 1km 출근의 가치가 350원이란 의미입니다.    
...
## 2. EBIS 란? 
#### 2.1 환경활동 보상 시스템    
![_config.yml]({{ site.baseurl }}/assets/img/l_2018040501000564300045011.jpg) 
...
### [더 보기: 2.2.2  사회적 비용과 경제적 가치](https://github.com/wooriapt/wooriapt.github.io/wiki/EBIS-White-Paper)
...
- **육성수**
  - 담당: 경제이론
  - 경력: 한국개발연구원/이코넥스 부사장
  - 학위: 미국 Purdue. Ph.D (환율이론)
- **안문택**
  - 담당: 증권법학
  - 경력: 금웅감독원 부원장/이코넥스 이사장
  - 학위: 고려대법대/서울대 법학박사
- **김용주**
  - 담당: 환경경제학/가치 평가
  - 경력: 서울디지털 대학 교수
  - 학위: 영국 New Castle Ph.D(환경경제학)
- **박근생**
  - 담당: 펀드레이징  
  - 경력: 테멘홀딩스㈜ 대표이사   
  - 학위: 연세대 경영학사  
